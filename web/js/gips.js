(function ($) {
    $.fn.extend({
        gips: function (options) {
            var settings = $.extend({ delay: 250, autoHide: false, pause: 5000, animationSpeed: 500, placement: 'top', theme: 'purple', imagePath: '/Telesur/web/images/delete.png', text: 'Debe ingresar con el mismo usuario y clave de su correo Zimbra. Si no posee debe comunicarse con la Ext. 264' }, options);
