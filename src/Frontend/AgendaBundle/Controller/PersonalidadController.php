...
class PersonalidadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FrontendAgendaBundle:Personalidad')->findAll();

        return $this->render('FrontendAgendaBundle:Personalidad:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FrontendAgendaBundle:Personalidad:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FrontendAgendaBundle:Personalidad')->find($id);
        ...
        return $this->render('FrontendAgendaBundle:Personalidad:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FrontendAgendaBundle:Personalidad:edit.html.twig', array(
            'entity'      => $entity,
