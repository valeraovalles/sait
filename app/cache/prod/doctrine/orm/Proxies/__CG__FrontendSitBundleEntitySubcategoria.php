 ...
 */
class Subcategoria extends \Frontend\SitBundle\Entity\Subcategoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'subcategoria', 'categoria');
    }
