...
class User extends \Administracion\UsuarioBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setFueradenomina($fueradenomina);
    }

    public function getFueradenomina()
    {
        $this->__load();
        return parent::getFueradenomina();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'username', 'salt', 'password', 'isActive', 'fueradenomina', 'rol');
    }
