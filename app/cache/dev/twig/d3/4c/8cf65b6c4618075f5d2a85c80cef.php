...
/* DistribucionBundle:Operador:top.html.twig */
class __TwigTemplate_d34c8cf65b6c4618075f5d2a85c80cef extends Twig_Template
{
...
";
    ...
    <div class=\"titulo\">SELECCIONE UN PAÍS</div>
    ...
    <script type=\"text/javascript\">
        \$(document).ready(function () {
            \$('#form_pais').change(function(){
                \$('#tipooperador').load('/sait/web/app_dev.php/distribucion/ajax_top/'+\$(\"#form_pais\").val()+'/tipooperador');
            });
...
";
    ...
    {
        return "DistribucionBundle:Operador:top.html.twig";
    }
