...
/* DistribucionBundle:Paquete:edit.html.twig */
class __TwigTemplate_5b170c33d356a5798fcce1bb2010b8a6 extends Twig_Template
{
    ...
    {
        // line 6
        echo "    DISTRIBUCIÓN - EDITAR PAQUETE
";
    }
    ...
    <div class=\"titulo\">EDITAR PAQUETE ";
        // line 12
        echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute($this->getContext($context, "entity"), "paquete")), "html", null, true);
        echo "</div>
...
;
        ...
        echo "
        <fieldset>
            <legend id=\"a\"><div class=\"divisor\">EDITAR DATOS DE PAQUETE</div></legend>
...
";
    ...
    {
        return "DistribucionBundle:Paquete:edit.html.twig";
    }
