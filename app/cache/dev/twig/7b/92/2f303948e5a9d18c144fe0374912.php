...
/* FrontendVisitasBundle:Visita:show.html.twig */
class __TwigTemplate_7b922f303948e5a9d18c144fe0374912 extends Twig_Template
{
    ...
    <table class=\"record_properties\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "entity"), "horaentrada"), "H:i:s"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Fechasalida</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 26
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "entity"), "horasalida"), "H:i:s"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Contacto</th>
    ...
    <li>
        <a href=\"";
        // line 41
        echo $this->env->getExtension('routing')->getPath("visita_control");
        echo "\">
            Back to the list
        </a>
    </li>
    ...
    <li>
        <form action=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("visita_delete_control", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\">
...
";
    ...
    {
        return "FrontendVisitasBundle:Visita:show.html.twig";
    }
