...
class __TwigTemplate_b51c043d2a3068823a683b9a3509ae92 extends Twig_Template
{
    ...
    {
        // line 1
        if (($this->getContext($context, "mostrar") == "estado")) {
            // line 2
...
\t\t<script>
        \$(\"#frontend_distribucionbundle_representantetype_telefono1\").val(";
            // line 4
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pais"), "codigo"), "html", null, true);
            echo ");
\t</script>\t
";
        }
