...
/* FrontendVisitasBundle:Visita:edit.html.twig */
class __TwigTemplate_56394c5a47cd9fa118440d5032a398a2 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Visita edit</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("visita_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
;
    ...
    <li>
        <form action=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("visita_delete", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\">
...
";
    ...
    {
        return "FrontendVisitasBundle:Visita:edit.html.twig";
    }
