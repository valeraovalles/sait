...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/visitas')) {
            ...
            // agregarnuevavisita
            if ($pathinfo === '/visitas/agregarnuevavisita') {
                return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::agregarnuevavisitaAction',  '_route' => 'agregarnuevavisita',);
            }
