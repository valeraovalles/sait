...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // frontend_visitas_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'frontend_visitas_homepage')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\DefaultController::indexAction',));
        }

        // visita
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'visita');
            }

            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::indexAction',  '_route' => 'visita',);
        }

        // visita_show
        if (preg_match('#^/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'visita_show')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::showAction',));
        }

        // visita_new
        if ($pathinfo === '/new') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::newAction',  '_route' => 'visita_new',);
        }
        ...
        if ($pathinfo === '/create') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_visita_create;
            }

            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::createAction',  '_route' => 'visita_create',);
        }
        not_visita_create:

        // visita_edit
        if (preg_match('#^/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'visita_edit')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::editAction',));
        }
        ...
        if (preg_match('#^/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                ...
                goto not_visita_update;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'visita_update')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::updateAction',));
        }
        not_visita_update:
        ...
        if (preg_match('#^/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'visita_delete')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\VisitaController::deleteAction',));
        }
        not_visita_delete:

        // usuario
        if ($pathinfo === '/usuario') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::indexAction',  '_route' => 'usuario',);
        }

        // usuario_show
        if (preg_match('#^/(?P<id>[^/]++)/showusuario$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_show')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::showAction',));
        }

        // usuario_new
        if ($pathinfo === '/newusuario') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::newAction',  '_route' => 'usuario_new',);
        }

        // usuario_create
        if ($pathinfo === '/createusuario') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_usuario_create;
            }

            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::createAction',  '_route' => 'usuario_create',);
        }
        not_usuario_create:

        // usuario_edit
        if (preg_match('#^/(?P<id>[^/]++)/editusuario$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_edit')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::editAction',));
        }

        // usuario_update
        if (preg_match('#^/(?P<id>[^/]++)/updateusuario$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                $allow = array_merge($allow, array('POST', 'PUT'));
                goto not_usuario_update;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_update')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::updateAction',));
        }
        not_usuario_update:

        // usuario_delete
        if (preg_match('#^/(?P<id>[^/]++)/deleteusuario$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                $allow = array_merge($allow, array('POST', 'DELETE'));
                goto not_usuario_delete;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_delete')), array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::deleteAction',));
        }
        not_usuario_delete:

        // usuario_busqueda
        if ($pathinfo === '/busqueda') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::busquedaAction',  '_route' => 'usuario_busqueda',);
        }

        // usuario_encontrado
        if ($pathinfo === '/encontrado') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::encontradoAction',  '_route' => 'usuario_encontrado',);
        }

        // cedula_cons
        if ($pathinfo === '/prueba') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::buscarAction',  '_route' => 'cedula_cons',);
        }

        // cedula_consulta
        if ($pathinfo === '/consulta') {
            return array (  '_controller' => 'Frontend\\VisitasBundle\\Controller\\UsuarioController::buscarAction',  'cedula' => 0,  '_route' => 'cedula_consulta',);
        }

        if (0 === strpos($pathinfo, '/licencias')) {
            // licencias_homepage
            if ($pathinfo === '/licencias/principal') {
                return array (  '_controller' => 'Frontend\\LicenciasBundle\\Controller\\LicenciasController::indexAction',  '_route' => 'licencias_homepage',);
            }

            // licencias_show
            if (0 === strpos($pathinfo, '/licencias/reportes') && preg_match('#^/licencias/reportes/(?P<id>[^/]++)/(?P<retorno>[^/]++)/show$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/distribucion')) {
            ...
            // pais_estado_ciudad
            if (0 === strpos($pathinfo, '/distribucion/paisestadociudad') && preg_match('#^/distribucion/paisestadociudad/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
