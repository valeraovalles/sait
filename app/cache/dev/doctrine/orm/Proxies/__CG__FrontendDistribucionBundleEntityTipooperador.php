 ...
 */
class Tipooperador extends \Frontend\DistribucionBundle\Entity\Tipooperador implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'operador', 'codigo', 'user');
    }
